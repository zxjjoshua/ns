...
void UdpEchoServerHelper::SetName(Ptr<Application> app,char* name){
  app->GetObject<UdpEchoServer>()->SetName (name);
}

char* UdpEchoServerHelper::GetName(Ptr<Application> app){
...
void UdpEchoClientHelper::SetName(Ptr<Application> app,char* name){
  app->GetObject<UdpEchoClient>()->SetName (name);
}

char* UdpEchoClientHelper::GetName(Ptr<Application> app){
